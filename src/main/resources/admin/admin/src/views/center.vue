<template>
  <div>
    ...
    >  
     <el-row>
      <el-col :span="12">
        <el-form-item   v-if="flag=='fuzeren'"  label="账号" prop="zhanghao">
          <el-input v-model="ruleForm.zhanghao" readonly              placeholder="账号" clearable></el-input>
        </el-form-item>
      </el-col>
      <el-col :span="12">
        <el-form-item   v-if="flag=='fuzeren'"  label="姓名" prop="xingming">
          <el-input v-model="ruleForm.xingming"               placeholder="姓名" clearable></el-input>
        </el-form-item>
      </el-col>
      <el-col :span="24">  
        <el-form-item v-if="flag=='fuzeren'" label="头像" prop="touxiang">
          <file-upload
          tip="点击上传头像"
          action="file/upload"
          :limit="3"
      ...
      <el-col :span="12">
        <el-form-item v-if="flag=='fuzeren'"  label="性别" prop="xingbie">
      ...
      <el-col :span="12">
        <el-form-item   v-if="flag=='fuzeren'"  label="联系方式" prop="lianxifangshi">
          <el-input v-model="ruleForm.lianxifangshi"               placeholder="联系方式" clearable></el-input>
        </el-form-item>
      </el-col>
      <el-col :span="12">
        <el-form-item   v-if="flag=='fuzeren'"  label="楼号" prop="louhao">
          <el-input v-model="ruleForm.louhao"               placeholder="楼号" clearable></el-input>
        </el-form-item>
      </el-col>
      <el-col :span="12">
        <el-form-item   v-if="flag=='fuzeren'"  label="房号" prop="fanghao">
      ...
      <el-col :span="12">
        <el-form-item   v-if="flag=='yonghu'"  label="房号" prop="fanghao">
          <el-input v-model="ruleForm.fanghao"               placeholder="房号" clearable></el-input>
        </el-form-item>
      </el-col>
...
export default {
  ...
  methods: {
    ...
    onUpdateHandler() {
      if((!this.ruleForm.zhanghao)&& 'fuzeren'==this.flag){
      ...
      if((!this.ruleForm.xingming)&& 'fuzeren'==this.flag){
      ...
      if( 'fuzeren' ==this.flag && this.ruleForm.lianxifangshi&&(!isMobile(this.ruleForm.lianxifangshi))){
