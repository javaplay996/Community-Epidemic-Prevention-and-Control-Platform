  ...
  <div>
      ...
      <div class="login-form">
		...
		<el-form ref="rgsForm" class="rgs-form" :model="rgsForm">
			...
			<el-form-item label="姓名" class="input" v-if="tableName=='fuzeren'">
			...
			<el-form-item label="联系方式" class="input" v-if="tableName=='fuzeren'">
			...
			<el-form-item label="楼号" class="input" v-if="tableName=='fuzeren'">
			...
			<el-form-item label="房号" class="input" v-if="tableName=='fuzeren'">
			  <el-input v-model="ruleForm.fanghao" autocomplete="off" placeholder="房号"  />
			</el-form-item>
			...
			<el-form-item label="房号" class="input" v-if="tableName=='yonghu'">
			  <el-input v-model="ruleForm.fanghao" autocomplete="off" placeholder="房号"  />
			</el-form-item>
...
export default {
  ...
  methods: {
	...
	var url=this.tableName+"/register";
      if((!this.ruleForm.zhanghao) && `fuzeren` == this.tableName){
      ...
      if((!this.ruleForm.xingming) && `fuzeren` == this.tableName){
        this.$message.error(`姓名不能为空`);
        return
      }
      if(`fuzeren` == this.tableName && this.ruleForm.lianxifangshi&&(!this.$validate.isMobile(this.ruleForm.lianxifangshi))){
