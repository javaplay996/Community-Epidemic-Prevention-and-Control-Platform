    ...
    >
      ...
      <el-col :span="12">
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="登记内容" prop="dengjineirong">
                <el-input
              ...
              <div v-else>
                <el-form-item v-if="ruleForm.dengjineirong" label="登记内容" prop="dengjineirong">
                    <span>{{ruleForm.dengjineirong}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
		 ...
		 if(crossrefid && crossuserid) {
			...
			this.$http({ 
				...
				if (data && data.code === 0) { 
					 ...
					 this.$http({
					   url: `renyuanmingdan/${!this.ruleForm.id ? "save" : "update"}`,
					   method: "post",
					   data: this.ruleForm
					 }).then(({ data }) => {
					   if (data && data.code === 0) {
						 ...
						 this.parent.renyuanmingdanCrossAddOrUpdateFlag = false;
						 this.parent.search();
