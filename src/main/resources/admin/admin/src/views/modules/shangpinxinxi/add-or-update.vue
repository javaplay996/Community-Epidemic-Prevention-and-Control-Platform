    ...
    >
      ...
      <el-col :span="12">
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="商品说明" prop="shangpinshuoming">
                <el-input
                  style="min-width: 200px; max-width: 600px;"
                  type="textarea"
                  :rows="8"
                  placeholder="商品说明"
                  v-model="ruleForm.shangpinshuoming" >
                </el-input>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.shangpinshuoming" label="商品说明" prop="shangpinshuoming">
                    <span>{{ruleForm.shangpinshuoming}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.shangpinjiage = true;
          ...
          if(o=='shangpinshuoming'){
            this.ruleForm.shangpinshuoming = obj[o];
	    this.ro.shangpinshuoming = true;
            continue;
          }
        }
      }
